...
from getmismatches import iteratereads_pairedend
...
if __name__ == '__main__':
    ...
    convs = iteratereads_pairedend(args.bam, args.onlyConsiderOverlap, snps, args.requireMultipleConv)

    #Assign reads to genes
    overlaps, numpairs = getReadOverlaps(args.bam, args.geneBed, args.chromsizes)
